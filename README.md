...
1. **Viewing Orders:**
   ...
   - Dynamically Created OrderDB for processing the Orders and save to Mongo DB.
...
- **Store-admin**: The automated order processing status can be monitored in the store admin interface for seamless management and tracking.
![alt text](assets/image-17.png)
- **MongoDB**: Once Azure Service Bus processes the orders, the order data is saved in MongoDB for persistent storage. This ensures the data is readily available for further operations. The placed orders can be viewed and managed using the MongoDB shell, providing easy access and management of stored order information.
